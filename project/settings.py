...
PROJECT_MODULE = 'games'

DEBUG = True
TEMPLATE_DEBUG = DEBUG

# For Postgres (not location aware) do from command line
# echo "CREATE USER games WITH PASSWORD 'games'" | sudo -u postgres psql
# echo "CREATE DATABASE games WITH OWNER games ENCODING 'UTF8'" | sudo -u postgres psql

# For Postgres (location aware) do from command line
# echo "CREATE USER games WITH PASSWORD 'games'" | sudo -u postgres psql
# echo "CREATE DATABASE games WITH OWNER games ENCODING 'UTF8'" | sudo -u postgres psql
# echo "CREATE EXTENSION postgis" | sudo -u postgres psql games
# echo "CREATE EXTENSION postgis_topology" | sudo -u postgres psql games

# For MySQL remember to first do from a MySQL shell:
# CREATE database games;
# GRANT ALL ON games.* TO 'games'@'localhost' IDENTIFIED BY 'games';
# FLUSH PRIVILEGES;
...
SECRET_KEY = '39d8262d2298e98aaa3e7dda976718a8dc48299fc08bd50eff30baab'
