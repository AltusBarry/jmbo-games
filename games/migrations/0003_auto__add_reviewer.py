...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'games_reviewer', (
            ...
            ('reviewer_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'games', ['Reviewer'])

        # Adding field 'Game.reviewer'
        db.add_column(u'games_game', 'reviewer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['games.Reviewer']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Game.reviewer'
        db.delete_column(u'games_game', 'reviewer_id')
    ...
    models = {
        ...
        u'games.reviewer': {
            'Meta': {'ordering': "('-publish_on', '-created')", 'object_name': 'Reviewer', '_ormbases': [u'jmbo.ModelBase']},
            u'modelbase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'}),
            'reviewer_name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
