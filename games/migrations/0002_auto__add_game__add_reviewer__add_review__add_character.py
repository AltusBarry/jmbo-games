...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'games_reviewer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'games', ['Reviewer'])

        # Adding model 'Review'
        db.create_table(u'games_review', (
            (u'modelbase_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['jmbo.ModelBase'], unique=True, primary_key=True)),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['games.Game'])),
            ('content', self.gf('ckeditor.fields.RichTextField')()),
            ('reviewer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['games.Reviewer'])),
            ('rating', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
        ))
        db.send_create_signal(u'games', ['Review'])

        # Adding model 'Character'
        db.create_table(u'games_character', (
            (u'modelbase_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['jmbo.ModelBase'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'games', ['Character'])

        # Adding M2M table for field games on 'Character'
        m2m_table_name = db.shorten_name(u'games_character_games')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('character', models.ForeignKey(orm[u'games.character'], null=False)),
            ('game', models.ForeignKey(orm[u'games.game'], null=False))
        ))
        db.create_unique(m2m_table_name, ['character_id', 'game_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'games_reviewer')

        # Deleting model 'Review'
        db.delete_table(u'games_review')

        # Deleting model 'Character'
        db.delete_table(u'games_character')

        # Removing M2M table for field games on 'Character'
        db.delete_table(db.shorten_name(u'games_character_games'))
    ...
    models = {
        ...
        u'games.character': {
            'Meta': {'ordering': "('-publish_on', '-created')", 'object_name': 'Character', '_ormbases': [u'jmbo.ModelBase']},
        ...
        u'games.game': {
            'Meta': {'ordering': "('-publish_on', '-created')", 'object_name': 'Game', '_ormbases': [u'jmbo.ModelBase']},
            u'modelbase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'games.review': {
            'Meta': {'ordering': "('-publish_on', '-created')", 'object_name': 'Review', '_ormbases': [u'jmbo.ModelBase']},
            ...
            'reviewer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['games.Reviewer']"})
        },
        u'games.reviewer': {
        ...
        u'games.trivialcontent': {
            'Meta': {'ordering': "('-publish_on', '-created')", 'object_name': 'TrivialContent', '_ormbases': [u'jmbo.ModelBase']},
            u'modelbase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'jmbo.modelbase': {
